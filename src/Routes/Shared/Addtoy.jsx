...
function AddToy() {
  ...
  return (
    <div>
      <div className="w-full px-4 lg:px-8 lg:w-2/3 bg-slate-100 mx-auto p-10 rounded-lg my-6 mt-16 ">
        ...
        <form onSubmit={handleAddToy}>
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            >
              ...
              <option defaultValue="baby-doll">Baby doll</option>
              <option defaultValue="barbie-doll">Barbie doll</option>
              <option defaultValue="american">American doll</option>
            </select>
            <input
              type="number"
              placeholder="Price"
